...
Consulte [Plataformas compatibles](https://experienceleague.adobe.com/en/docs/experience-manager-64/deploying/introduction/technical-requirements) para obtener más información sobre los requisitos y requisitos previos.

El Adobe AEM recomienda utilizar la última versión de Dispatcher para beneficiarse de las últimas funciones, las correcciones de errores más recientes y el mejor rendimiento posible.
...
* DISP-1013: añada compatibilidad con openssl 3.0 para Linux®.
...
* DISP-944: cargar previamente URL de vanidad
...
* DISP-826: admite la recuperación de URI con una cadena de consulta
...
* DISP-742: las solicitudes bloqueadas pueden filtrar información a recursos protegidos por el comprobador de autenticación
...
* DISP-693: actualizar detalles arquitectónicos para los servidores Solaris™ en la página de descarga de Dispatcher
* DISP-695: problema con el nivel de DispatcherLog en el módulo 4.2.3 de Dispatcher
* DISP-698: Dispatcher TTL debe admitir s-maxage y directivas privadas
...
* DISP-705: bloqueo de Dispatcher debido a doble libertad o corrupción (`fasttop`)
