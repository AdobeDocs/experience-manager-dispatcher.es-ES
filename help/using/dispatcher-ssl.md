---
title: Utilización de SSL con Dispatcher
...
# Utilización de SSL con Dispatcher {#using-ssl-with-dispatcher}
...
## Utilización de SSL cuando Dispatcher se conecta a AEM {#use-ssl-when-dispatcher-connects-to-aem}
...
* [Uso del asistente SSL en AEM](https://experienceleague.adobe.com/es/docs/experience-manager-learn/foundation/security/use-the-ssl-wizard)
...
Para configurar un certificado SSL mutuo, necesita certificados firmados por una entidad emisora de certificados (CA) de confianza. Los certificados autofirmados no son adecuados. Puede actuar como CA o utilizar los servicios de una CA de terceros para firmar sus certificados. Para configurar SSL mutuo, necesita los siguientes elementos:
...
1. [Cree un almacén de claves que contenga el certificado de procesamiento](dispatcher-ssl.md#main-pars-title-6) y configure el servicio HTTP del procesamiento.
1. [Configure el módulo del servidor web de Dispatcher](dispatcher-ssl.md#main-pars-title-4) para SSL mutuas.

### Creación u obtención de certificados firmados por la CA {#creating-or-obtaining-ca-signed-certificates}

Cree o consiga los certificados firmados por la CA que autentican la instancia de publicación y a Dispatcher.
...
#### Creación de los certificados {#creating-the-certificates}
...
#### Añadir el certificado de CA al almacén de confianza del procesador {#adding-the-ca-cert-to-the-render-s-truststore}
...
Para configurar el servicio HTTP de la instancia de procesamiento para que utilice SSL, utilice el certificado de procesamiento con las instrucciones en la sección *`Enable SSL on the Publish Instance`*:

* AEM 6.2: [Habilitación de HTTP sobre SSL](https://experienceleague.adobe.com/es/docs/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions)
* AEM 6.1: [Habilitación de HTTP sobre SSL](https://experienceleague.adobe.com/es/docs/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions)
* Versiones de AEM anteriores: consulte [esta página.](https://experienceleague.adobe.com/es/docs/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions)

### Configuración de SSL para el módulo de Dispatcher {#configuring-ssl-for-the-dispatcher-module}
...
### Creación de un certificado de Dispatcher unificado {#creating-a-unified-dispatcher-certificate}
...
* `DispatcherCACertificateFile`: Ruta al archivo de certificado de la CA. Se utiliza si el servidor SSL presenta una CA en la que una entidad raíz no confía.
